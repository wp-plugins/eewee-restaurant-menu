<?php
if( !class_exists(Form_PlatCategorieEdit)){
	class Form_PlatCategorieEdit extends WP_Query{
		 ...
		 * retourn form
 		 * @param array $r
 		 */ 
		public function platcategorieEdit( $r ){ ?>
			
			<form method="post" action="<?php echo $this->_action; ?>">
				<input type='hidden' name='form_id' value='<?php echo $r[0]->ID_PLAT_CATEGORIE; ?>' />

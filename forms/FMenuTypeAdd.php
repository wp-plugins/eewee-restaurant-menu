<?php
if( !class_exists(Form_MenuTypeAdd)){
	class Form_MenuTypeAdd extends WP_Query{
		 ...
		 * retourn form
 		 * @param $_POST $p
 		 */ 
		public function menutypeAdd( $p="" ){ ?>
			<form method="post" action="<?php echo $this->_action; ?>">
				<input type='hidden' name='form_id' value='<?php echo $p[0]->ID_MENUTYPE; ?>' />

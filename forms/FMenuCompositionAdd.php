<?php
if( !class_exists(Form_MenuCompositionAdd)){
	class Form_MenuCompositionAdd extends WP_Query{
		 ...
		 * retourn form
 		 * @param $_POST $p
 		 */ 
		public function menucompositionAdd( $p="" ){ ?>
			<form method="post" action="<?php echo $this->_action; ?>">
				<input type='hidden' name='form_id' value='<?php echo $p[0]->ID_MENU_COMPOSITION; ?>' />
                                                        ...
                                                        <td>
                                                                ...
                                                                ?><select name='form_menuComposition'><?php
                                                                        foreach( $menus as $menu ){
                                                                                if( $menu->ID_MENU_CATEGORIE == $p['form_idMenu'] ){
                                                                                        $selected = "selected";
                                                                                }else{
                                                                                        $selected = "";
                                                                                }
                                                        ...
                                                        <td>
                                                                ...
                                                                ?><select name='form_menuType'><?php
                                                                        foreach( $menuTypes as $menuType ){
                                                                                if( $menuType->ID_MENU_TYPE == $p['form_idMenuType'] ){
                                                                                        $selected = "selected";
                                                                                }else{
                                                                                        $selected = "";
                                                                                }
